...
The process of making ecological forecasts will help us understand the range of future responses of ecological systems, quantify which aspects of the future are highly uncertain, and inform management decisions to promote resiliency. In my [post-doctoral research] ({{< ref "/content/project/internal-project/index.md" >}}), I am fusing tree-ring and forest inventory data to make forecasts about forest responses to climate change, and to identify forest management strategies (changes in forest stocking density, average tree size, etc.) that maximize resilience to extreme climate conditions. 
