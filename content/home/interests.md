...
Specifically, [I have used tree rings to quantify past responses of tree growth to rising CO2 and concurrent changes in climate over the 20th century]({{< ref "/project/project3/index.md" >}}) . What we find is that rising CO2 may have a small positive effect on tree growth, this is cancelled out by a drastic decrease in tree growth in response to a warmer future. [I have also explored the effects of past climate and vegetation-disturbance feedbacks on a temperate savanna-forest boundary, and quantified the subsequent land-use driven collapse of alternative stable states at this savanna-forest boundary.]({{< ref "/project/old/index.md" >}})  Within the ecoregion scale, I quantify the [relative roles that environmental gradients and species interactions play in determining species aboveground biomass distribution]({{< ref "/project/GJAM/index.md" >}}), allowing us to better predict changes in biomass due to both climatic change, and land-use driven the loss of species interactions. 
